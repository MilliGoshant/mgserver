...
// Context is the most important part of server. It allows us to pass variables between middleware,
...
//
//	router.GET("/user/:id", func(c *server.Context) {
...
func (c *Context) ClientIP() string {
	...
	if c.engine.AppEngine {
		log.Println(`The AppEngine flag is going to be deprecated. Please check issues #2723 and #2739 and use 'TrustedPlatform: server.PlatformGoogleAppEngine' instead.`)
